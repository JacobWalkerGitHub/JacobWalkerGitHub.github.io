...
### 2.1 Minimum Age
You must be at least 13 years of age to create an account and use Nect. If you are under 18, you represent that you have your parent or guardian's permission to use the App.
...
You may delete your account at any time through the App's settings. Upon deletion, your account and associated data will be permanently removed from our systems.
...
- Follow other users and view their public content
...
- Promotes hate speech, discrimination, or bigotry based on race, ethnicity, religion, gender, sexual orientation, disability, or any other protected characteristic
- Infringes on intellectual property rights, including copyrights, trademarks, or patents
- Contains spam, advertisements, or promotional material not authorized by us
...
Nect uses your device's location to:
...
### 8.1 Advertisements
Nect displays advertisements through Google AdMob. Your interaction with advertisements is governed by Google's privacy policies and terms of service.
...
Nect may contain links to third-party websites or services. We are not responsible for the content, privacy policies, or practices of any third-party sites.

## 9. Premium Features and In-App Purchases

### 9.1 Future Offerings
We may offer subscription plans and in-app purchases in the future. When available, these will be subject to additional terms and pricing information provided at the time of purchase.

### 9.2 Payments
All purchases are processed through the Apple App Store. Refunds and payment disputes are subject to Apple's policies.
...
- Receive multiple content violations
...
- You will not be entitled to any refund of fees paid (if applicable)

## 11. Privacy and Data Protection

Your use of Nect is also governed by our [Privacy Policy](index.html), which explains how we collect, use, and protect your personal information. By using the App, you consent to our data practices as described in the Privacy Policy.
...
Your continued use of Nect after changes to these Terms constitutes your acceptance of the revised Terms. If you do not agree to the changes, you must stop using the App and delete your account.
...
Any disputes arising from these Terms or your use of Nect shall be resolved through:
1. Good faith negotiation
2. Mediation (if negotiation fails)
3. Binding arbitration in accordance with the American Arbitration Association rules
